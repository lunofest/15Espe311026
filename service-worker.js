const CACHE_NAME = 'cache-v66'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v66',
    'estilos/styles.css?v66',
    'estilos/mediaQueries.css?v66',
    'javascript/script.js?v66',
